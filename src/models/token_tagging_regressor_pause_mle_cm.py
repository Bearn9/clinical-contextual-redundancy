...
class TokenTaggingRegressorPauseMLE(LightningModule):
    ...
    def __init__(
        ...
        #self.savepath = f"./losses_cm/pause_{huggingface_model}"
    ...
    def step(self, batch: Dict[str, torch.tensor], verbose: bool = False):
        ...
        # cso
        masked_gaussian_nll_batch = masked_nll.detach()
        ...
        return masked_nll_mean, pred, var, loss_table, freq_table

    def training_step(self, batch: Dict[str, torch.tensor], batch_idx: int, verbose: bool = False):
        ...
        loss, preds, var, loss_table, freq_table = self.step(batch) #cso
